...
################################################################################################
################################################################################################
# https://github.com/tiangolo/uwsgi-nginx-docker/blob/master/python3.6-alpine3.8/Dockerfile
################################################################################################
################################################################################################
################################################################################################
################################################################################################
...
################################################################################################
################################################################################################
#https://github.com/tiangolo/uwsgi-nginx-flask-docker/blob/master/python3.6-alpine3.8/Dockerfile
################################################################################################
################################################################################################
################################################################################################
################################################################################################
...
RUN apk --no-cache add --virtual .builddeps \
    ...
    pip3 install cython && \
    apk add --update --no-cache py3-scipy lapack && \
    PYTHONPATH=/usr/lib/python3.6/site-packages python -m pip install -r requirements.txt && \
    apk del .builddeps && \
